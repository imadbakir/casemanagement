...
export class CustomerCreateComponent extends FormioResourceCreateComponent implements OnInit, OnDestroy {
  ...
  onSubmit(submission) {
    ...
    this.service
      ...
      .then(function () {
        ...
        component.router.navigate(['/customer']);
  ...
  ngOnInit() {
    ...
    this.service.resources['customer'].resourceLoaded.then((event) => {
