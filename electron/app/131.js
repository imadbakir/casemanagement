...
function importHardwareBackButton(win, config) {
    ...
    if (hardwareBackConfig) {
        __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.bind(null, /*! ./hardware-back-button.js */ "./node_modules/@ionic/core/dist/esm/es5/build/hardware-back-button.js")).then(function (module) { return module.startHardwareBackButton(win); });
    }
}
function importStatusTap(win, config, queue) {
    ...
    if (statusTap) {
        __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ./status-tap.js */ "./node_modules/@ionic/core/dist/esm/es5/build/status-tap.js")).then(function (module) { return module.startStatusTap(win, queue); });
    }
}
function importTapClick(win) {
    __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./tap-click.js */ "./node_modules/@ionic/core/dist/esm/es5/build/tap-click.js")).then(function (module) { return module.startTapClick(win.document); });
}
function importInputShims(win, config) {
    var inputShims = config.getBoolean('inputShims', needInputShims(win));
    if (inputShims) {
        __webpack_require__.e(/*! import() */ 6).then(__webpack_require__.bind(null, /*! ./input-shims.js */ "./node_modules/@ionic/core/dist/esm/es5/build/input-shims.js")).then(function (module) { return module.startInputShims(win.document, config); });
    }
}
